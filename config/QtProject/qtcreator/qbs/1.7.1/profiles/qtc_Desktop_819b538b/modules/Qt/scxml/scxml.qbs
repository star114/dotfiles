...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/local/Cellar/qt/5.8.0_2/lib/QtScxml.framework/QtScxml"

    cpp.defines: ["QT_SCXML_LIB"]
    cpp.includePaths: ["/usr/local/Cellar/qt/5.8.0_2/lib/QtScxml.framework/Headers"]
    cpp.libraryPaths: []
