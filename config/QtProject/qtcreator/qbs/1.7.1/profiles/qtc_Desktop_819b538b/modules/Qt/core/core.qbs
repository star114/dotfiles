...
Module {
    ...
    property string libFilePathRelease: "/usr/local/Cellar/qt/5.8.0_2/lib/QtCore.framework/QtCore"
    ...
    cpp.includePaths: {
        var paths = ["/usr/local/Cellar/qt/5.8.0_2/lib/QtCore.framework/Headers"];
